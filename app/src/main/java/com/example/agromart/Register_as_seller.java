...
public class Register_as_seller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Registerhelperclass seller = new Registerhelperclass(name,mail,mobile,password);
                // Toast.makeText(Register_as_seller.this,"Welcome "+seller.name,Toast.LENGTH_SHORT).show();
                ref.child("users").child("sellers").child("SELLER"+mobile).setValue(seller);

                mauth.createUserWithEmailAndPassword(mail, password)
                        .addOnCompleteListener(Register_as_seller.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    // Sign in success, update UI with the signed-in user's information
                                    FirebaseUser user = mauth.getCurrentUser();
                                    Toast.makeText(Register_as_seller.this,"Registration Successful!!!",Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(Register_as_seller.this,Homescreen.class));
                                    overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                                    finish();
                                } else {
                                    // If sign in fails, display a message to the user.
                                    Toast.makeText(Register_as_seller.this,"Registration Failed!!!",Toast.LENGTH_SHORT).show();
                                }
